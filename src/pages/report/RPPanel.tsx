...
export const RPPanel = () => {
    ...
    const form = useFormik({
        ...
        onSubmit: (values) => {
            axios({
                url: `https://arn.pem-sa.com.mx/task-pss/report`,
                method: 'POST',
                responseType: 'blob',
                data: values
            })
                .then((response) => {
                    ...
                    link.href = url;
                    link.setAttribute('download', `${values.name}.xlsx`);
    ...
    return (
        <div className='view'>
            ...
            <section className='title-view'>
                <h2>Reporte de clientes sin señal</h2>
            </section>
            ...
            <section className='report'>
                <form action="" className='form report__form' onSubmit={form.handleSubmit}>
                    ...
                    <div className='form__container'>
                        <label htmlFor="">Fecha de corte</label>
                        <input
                            type="date"
                            id='startDate'
                            name='startDate'
